...
public class MetadataController
{
    ...
    public ModelAndView createMetadata(@ModelAttribute( "metadata" ) MetadataForm metadata, BindingResult
        bindingResult) throws MetadataProviderException, MarshallingException, KeyStoreException
    {
        ...
        {
            ModelAndView modelAndView = new ModelAndView( new InternalResourceView(
        ...
        if ( metadata.isIncludeDiscovery() )
        {
            ...
            if ( metadata.getCustomDiscoveryResponseURL() != null && metadata.getCustomDiscoveryResponseURL().length
                () > 0 )
            {
    ...
    protected String getMetadataAsString(EntityDescriptor descriptor, ExtendedMetadata extendedMetadata) throws
    ...
    protected String getConfiguration(String fileName, ExtendedMetadata metadata)
    {
        ...
        sb.append( "           <property name=\"securityProfile\" value=\"" ).append( metadata.getSecurityProfile() ).append( "\"/>\n" + "           <property name=\"sslSecurityProfile\" value=\"" ).append( metadata
            .getSslSecurityProfile() ).append( "\"/>\n" + "           <property name=\"sslHostnameVerification\" " +
            "value=\"" ).append( metadata.getSslHostnameVerification() ).append( "\"/>\n" + "           <property " +
            "name=\"signMetadata\" value=\"" ).append( metadata.isSignMetadata() ).append( "\"/>\n" + "           " +
        ...
        {
            sb.append( "           <property name=\"signingAlgorithm\" value=\"" ).append( metadata
                .getSigningAlgorithm() ).append( "\"/>\n" );
        }
        sb.append( "           <property name=\"requireArtifactResolveSigned\" value=\"" ).append( metadata
            .isRequireArtifactResolveSigned() ).append( "\"/>\n" + "           <property " +
            "name=\"requireLogoutRequestSigned\" value=\"" ).append( metadata.isRequireLogoutRequestSigned() ).append
            ( "\"/>\n" + "           <property name=\"requireLogoutResponseSigned\" value=\"" ).append( metadata
            .isRequireLogoutResponseSigned() ).append( "\"/>\n" );
