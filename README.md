 ...
 * The fortress-sampl-demo is a third step.  It hooks Apache Directory Fortress component with Spring Saml.  The use case connects with a common Identity Provider, SSO Circle.com.
