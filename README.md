 ...
 * This demo won't show the various SAML 2.0 use cases.  It will show how Fortress may be combined with Spring Security to complete SAML authN and RBAC authZ use cases.
